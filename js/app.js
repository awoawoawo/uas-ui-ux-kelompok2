const AppState = {
    ...
    programs: [
        { id: "cs", name: "Ilmu Komputer / Teknik Informatika", category: "tek", desc: "Fokus pada pengembangan software, algoritma, dan kecerdasan buatan.", cost: "Rp 8-12 Juta/Semester", duration: "8 Semester", career: "Software Engineer, Data Scientist" },
        { id: "is", name: "Sistem Informasi", category: "tek", desc: "Menjembatani teknologi informasi dan kebutuhan bisnis perusahaan.", cost: "Rp 7-10 Juta/Semester", duration: "8 Semester", career: "IT Consultant, Systems Analyst" },
        { id: "dkv", name: "Desain Komunikasi Visual (DKV)", category: "seni", desc: "Mempelajari penyampaian pesan melalui media visual dan desain.", cost: "Rp 9-15 Juta/Semester", duration: "8 Semester", career: "Graphic Designer, Art Director" },
        { id: "arch", name: "Arsitektur", category: "seni", desc: "Fokus pada desain bangunan yang fungsional, estetis, dan aman.", cost: "Rp 10-15 Juta/Semester", duration: "8 Semester", career: "Arsitek, Urban Planner" },
        { id: "psy", name: "Psikologi", category: "sos", desc: "Mempelajari perilaku dan proses mental manusia.", cost: "Rp 7-11 Juta/Semester", duration: "8 Semester", career: "HRD, Konselor, Peneliti" },
        { id: "ir", name: "Hubungan Internasional", category: "sos", desc: "Mempelajari dinamika interaksi antar negara dan organisasi global.", cost: "Rp 8-12 Juta/Semester", duration: "8 Semester", career: "Diplomat, Analis Kebijakan" },
        { id: "mgmt", name: "Manajemen", category: "eko", desc: "Fokus pada pengelolaan sumber daya organisasi untuk mencapai tujuan.", cost: "Rp 7-10 Juta/Semester", duration: "8 Semester", career: "Business Manager, Entrepreneur" },
        { id: "acc", name: "Akuntansi", category: "eko", desc: "Mempelajari pencatatan dan pelaporan transaksi keuangan secara presisi.", cost: "Rp 7-10 Juta/Semester", duration: "8 Semester", career: "Akuntan, Auditor, Analis Keuangan" }
    ],
...
function renderComparison() {
    ...
    let html = `
        <div class="text-center" style="margin-top: 2rem; margin-bottom: 4rem;">
            ...
            <p class="text-muted" style="font-size: 1.125rem;">Bandingkan spesifikasi detail dari program studi rekomendasi Anda secara *head-to-head*.</p>
        </div>
...
function openProgramModal(id) {
    ...
    modalContent.innerHTML = `
        <div style="text-align: center; margin-bottom: 1.5rem;">
            ...
            <span class="badge-neutral" style="display: inline-block;">Kategori: ${prog.category.toUpperCase()}</span>
        </div>
